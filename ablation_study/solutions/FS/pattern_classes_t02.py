class Temperature:
    ...
    FS Strategy: Store in canonical form (Celsius), compute conversions on demand.
    Meta-insight: Properties enable computed attributes - clean separation of storage/interface.
    """
