...
class SimpleCache:
    ...
    FS Strategy: Store (value, expiration_time) tuples, lazy cleanup on access.
    Advanced pattern: Combines classes with error handling (time-based logic) and dict management.
    """
